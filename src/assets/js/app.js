...
//Local mac
// BASE_API_SERVER: 'http://localhost:5000/',
// BASE_API: 'http://localhost:5000/api/v1/',
// BASE_APP: 'http://localhost:9000/#!/',

//Local : windows
// BASE_API_SERVER: 'http://zs-api.com/',
// BASE_API: 'http://zs-api.com/api/v1/',
// BASE_APP: 'http://localhost:9000/#!/',

//prod
BASE_API_SERVER: 'https://api.zonasoccer.net/',
BASE_API: 'https://api.zonasoccer.net/api/v1/',
BASE_APP: 'https://reserve.zonasoccer.net/#!/',
});
        ...
        $urlRouterProvider.otherwise('/home');
         ...
         $stateProvider
             .state('home', {
                url: '/home/:token',
                controller: 'HomeCtrl',
                templateUrl: 'assets/js/modules/home/views/home.html',
                resolve: {
                    deps: ['$ocLazyLoad', function($ocLazyLoad) {
                        return $ocLazyLoad.load({
                            ...
                            serie: true,
                            files: [
                                { type: 'js', path: 'https://maps.googleapis.com/maps/api/js?key=AIzaSyCi7ddqvFM0nNNyA7euyCV2fPLV7DUmALQ' },
             ...
             .state('reserve', {
                ...
                templateUrl: 'assets/js/modules/reserve/views/reserve2.html',
                resolve: {
                    deps: ['$ocLazyLoad', function($ocLazyLoad) {
                        return $ocLazyLoad.load({
                            insertBefore: '#css-bootstrap',
            ...
            .state('success', {
                url: '/success/:session_token',
                controller: 'ReservationCtrl',
                templateUrl: 'assets/js/modules/reserve/views/success.html',
                resolve: {
                    deps: ['$ocLazyLoad', function($ocLazyLoad) {
                        return $ocLazyLoad.load({
                            insertBefore: '#css-bootstrap',
            ...
            .state('list', {
                url: '/pickuplist/:token',
                controller: 'PickupListCtrl',
                templateUrl: 'assets/js/modules/pickuplist/views/pickuplist.html',
                resolve: {
                    deps: ['$ocLazyLoad', function($ocLazyLoad) {
                        return $ocLazyLoad.load({
                            insertBefore: '#css-bootstrap',
            ...
            .state('listsuccess', {
                url: '/pickupsuccess/:token',
                controller: 'PickupListCtrl',
                templateUrl: 'assets/js/modules/pickuplist/views/pickupsuccess.html',
                resolve: {
                    deps: ['$ocLazyLoad', function($ocLazyLoad) {
                        return $ocLazyLoad.load({
                            insertBefore: '#css-bootstrap',
            ...
            .state('pickups', {
                ...
                templateUrl: 'assets/js/modules/pickups/views/pickups.html',
                resolve: {
                    deps: ['$ocLazyLoad', function($ocLazyLoad) {
                        return $ocLazyLoad.load({
                            insertBefore: '#css-bootstrap',
             ...
             .state('pickup', {
                ...
                templateUrl: 'assets/js/modules/pickup/views/pickup.html',
                resolve: {
                    deps: ['$ocLazyLoad', function($ocLazyLoad) {
                        return $ocLazyLoad.load({
                            insertBefore: '#css-bootstrap',
              ...
              .state('pickupsuccess', {
                url: '/pickup/success/:token',
                controller: 'PickupCtrl',
                templateUrl: 'assets/js/modules/pickup/views/success.html',
                resolve: {
                    deps: ['$ocLazyLoad', function($ocLazyLoad) {
                        return $ocLazyLoad.load({
                            insertBefore: '#css-bootstrap',
            ...
            .state('calendartest', {
                url: '/calendartest',
                templateUrl: 'assets/js/modules/reserve/views/calendar.html'
            })
            .state('cancelled', {
                url: '/cancelled/:token',
                templateUrl: 'assets/js/modules/reserve/views/cancelled.html'
            })
...
// Run our App
App.run(function($rootScope, uiHelpers,$transitions, MetaTagsService) {
    MetaTagsService.setDefaultTags({
    // General SEO
    'title': 'Zonasoccer Reservation Engine',
    'author': 'Zonasoccer.net',
    'description': 'Manage field reservations, players lists and pickup games',
    // Indexing / Spiders
    'googlebot': 'all',
    'bingbot': 'all',
    'robots': 'all',
    // OpenGraph
    'og:site_name': 'ZonaSoccer Reservation Engine',
    // Twitter
...
App.controller('AppCtrl', ['$scope', '$localStorage', '$window',
    function ($scope, $localStorage, $window) {
        ...
        $scope.oneui = {
            ...
            settings: {
                activeColorTheme: 'amethyst', // Set a color theme of your choice, available: 'amethyst', 'city, 'flat', 'modern' and 'smooth'
                sidebarLeft: false, // true: Left Sidebar and right Side Overlay, false: Right Sidebar and left Side Overlay
                ...
                sideScroll: false, // Enables custom scrolling on Sidebar and Side Overlay instead of native scrolling (> 991px)
                headerFixed: false // Enables fixed header
            }
        };
